...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('source/css/riwayat-pembelian.css') }}">
...
<body>
    ...
    <div>
        ...
        @yield('riwayat-pembelian') {{-- jadi ini nanti isinya halaman-halaman lain, biar pake boostrap nya 1 aja --}}
