...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('source/css/detail-barang.css') }}">
...
<body>
    ...
    <div>
        ...
        @yield('detail-barang') {{-- jadi ini nanti isinya halaman-halaman lain, biar pake boostrap nya 1 aja --}}
