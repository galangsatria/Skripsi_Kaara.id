...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('source/css/request-barang.css') }}">
...
<body>
    ...
    <div>
        ...
        @yield('request-barang') {{-- jadi ini nanti isinya halaman-halaman lain, biar pake boostrap nya 1 aja --}}
