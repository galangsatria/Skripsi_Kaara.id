...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('source/css/detail-pemesanan.css') }}">
...
<body>
    ...
    <div>
        ...
        @yield('detail-pemesanan') {{-- jadi ini nanti isinya halaman-halaman lain, biar pake boostrap nya 1 aja --}}
