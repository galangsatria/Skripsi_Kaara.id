...
@section('tentang-kami')
    <div class="container p-5 text-center">
        <h1 style="color: #A977B2">Tentang Kami</h1>
    </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-9">
                    ...
                    <p class="deskripsi-kaara">Kaara.id merupakan toko penyedia layanan jasa titip barang fashion yang telah
                        berdiri
                        sejak 2019 dan
                        tetap konsisten melayanin konsumen. Kami melayani jasa titip dari beberapa negara termasuk
                        Singapore, USA, dan lain-lain. Kami memberikan jaminan barang berkualitas dengan harga jasa yang
                        terjangkau.</p>
                </div>
            </div>
        </div>
    ...
    <div class="container pt-5">
        <div class="caption-sectwo text-center">
            <h3>Kami Menawarkan Pelayanan Terbaik</h3>
            <h4 class="caption-section3 mt-4">Kaara.id memberikan jaminan pengalaman berbelanja</h4>
            <h4 class="caption-section3 mb-3" style="padding-bottom: 33px;">yang luar biasa kepada konsumen</h4>
        </div>
    ...
    <div class="section-tiga mb-5">
        <div class="container pt-5 px-5">
            <div class="row px-5">
                <p class="banner-tiga" style="padding-right: 150px; padding-left:150px;">“Kami memberikan pelayanan yang
                    terbaik dan terpercaya terhadap konsumen
                    Kaara.id.
                    Konsistensi kami
                    menjamin
                    konsumen hanya perlu duduk di rumah, memilih barang, dan menunggu barang sampai. Belanja tanpa ribet
                    bersama
                    Kaara.id”</p>
            </div>
            <div class="row text-center">
                <p class="banner-tiga mt-5">Anastasya Aprilia - Owner Kaara.id</p>
            </div>
        </div>
    </div>
@endsection
