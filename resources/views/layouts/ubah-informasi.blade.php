...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('source/css/ubah-informasi.css') }}">
...
<body>
    ...
    <div>
        ...
        @yield('ubah-informasi') {{-- jadi ini nanti isinya halaman-halaman lain, biar pake boostrap nya 1 aja --}}
